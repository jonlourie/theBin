...
export default function DerivativesPurchaseSection() {
    ...
    //useEffect(() => {
        //const getNftData = async () => {
            //const response = await axios.get("http://localhost:5001/getcontractnft", {  
               // params: {
                    //contractAddress: "0x910524678c0b1b23ffb9285a81f99c29c11cbaed", ///0xED5AF388653567Af2F388E6224dC7C4b3241C544
                //,     
            //});
